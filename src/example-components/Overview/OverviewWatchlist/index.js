...
import { Grid, List, ArrowDownRight, ArrowUpRight } from 'react-feather';
      ...
      <Card className="mb-5">
        <CardHeader className="d-flex align-items-center justify-content-between card-header-alt p-4">
          ...
          <div className="d-flex align-items-center">
            <Button
              color="neutral-dark"
              className="d-flex align-items-center justify-content-center d-40 active mr-2 border-0 p-0 rounded-pill">
              <Grid className="w-50" />
            </Button>
            <Button
              color="neutral-dark"
              className="d-flex align-items-center justify-content-center d-40 border-0 p-0 rounded-pill">
              <List className="w-50" />
            </Button>
          </div>
        </CardHeader>
              ...
              <div className="px-4 pt-4">
                ...
                <div className="d-flex my-3 justify-content-between align-items-center">
                  ...
                  <div className="text-success">
                    <ArrowUpRight className="font-size-xxl" />
                  </div>
                </div>
                <div>
                  <Chart
              ...
              <div className="px-4 pt-4">
                ...
                <div className="d-flex my-3 justify-content-between align-items-center">
                  ...
                  <div className="text-danger">
                    <ArrowDownRight className="font-size-xxl" />
                  </div>
                </div>
                <div>
                  <Chart
